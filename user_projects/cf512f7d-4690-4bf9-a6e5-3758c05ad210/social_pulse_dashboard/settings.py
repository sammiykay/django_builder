...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-development-key-social_pulse_dashboard')
...
ROOT_URLCONF = 'social_pulse_dashboard.urls'
...
WSGI_APPLICATION = 'social_pulse_dashboard.wsgi.application'
...
ASGI_APPLICATION = 'social_pulse_dashboard.asgi.application'
CHANNEL_LAYERS = {
    'default': {
