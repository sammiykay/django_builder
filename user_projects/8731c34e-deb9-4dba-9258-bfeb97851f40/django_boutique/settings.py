...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-development-key-django_boutique')
...
ROOT_URLCONF = 'django_boutique.urls'
...
WSGI_APPLICATION = 'django_boutique.wsgi.application'
...
ASGI_APPLICATION = 'django_boutique.asgi.application'
CHANNEL_LAYERS = {
    'default': {
