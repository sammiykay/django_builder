...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-development-key-django_requirements_validator')
...
ROOT_URLCONF = 'django_requirements_validator.urls'
...
WSGI_APPLICATION = 'django_requirements_validator.wsgi.application'
