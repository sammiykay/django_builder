...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-development-key-django_blog_master')
...
ROOT_URLCONF = 'django_blog_master.urls'
...
WSGI_APPLICATION = 'django_blog_master.wsgi.application'
...
ASGI_APPLICATION = 'django_blog_master.asgi.application'
CHANNEL_LAYERS = {
    'default': {
