...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-development-key-django_blog_platform')
...
ROOT_URLCONF = 'django_blog_platform.urls'
...
WSGI_APPLICATION = 'django_blog_platform.wsgi.application'
